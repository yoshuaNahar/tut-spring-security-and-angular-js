...
var WriteComponent = ng.core.Component({
  ...
  constructor: [AppService, ng.http.Http, function (app, http) {
    ...
    self.update = function () {
      http.post('/resource', {content: self.greeting.content}).subscribe(
          function (response) {
...
var AppComponent = ng.core.Component({
  ...
  constructor: [AppService, ng.http.Http, ng.router.Router,
    function (app, http, router) {
      var self = this;
      self.user = {};
...
var AdminModule = ng.core.NgModule({
  ...
  declarations: [ReadComponent, WriteComponent, UnauthenticatedComponent,
    ChangesComponent, AppComponent],
  providers: [{
